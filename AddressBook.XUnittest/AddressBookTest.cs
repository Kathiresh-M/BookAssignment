...
namespace AddressBookXUnittest
{
    public class AddressBookTest
    {
        ...
        [Fact]
        public void GetAddressBookCount_CheckUser_ReturnTrue()
        {
            var DbContextConnection = GetDBContextupdate();
        ...
        public void DeleteAddressBook_CheckAddressBookId_ReturnOkStatus()
        {
            ...
            //Guid ValidAddressBookId = Guid.Parse("");
        ...
        AddressBookResource getobject = new AddressBookResource()
        {
            PageNumber = 1,
            PageSize = 1,
            SortBy = "FirstName",
        ...
        public void GetAllAddressBook_Valid_ReturnStatus()
        {
            var DbContextConnection = GetDBContextupdate();
            ...
            var result = controllerfile.GetAddressBooks(getobject);

            OkObjectResult list = result as OkObjectResult;

            List<UserDto> listbook = list.Value as List<UserDto>;

            Assert.IsType<OkObjectResult>(result);

            Assert.Equal(1, listbook.Count);
        }
        ...
        public void UpdateAddressBook_Valid_ReturnOkStatus()
        {
            /*BookRepository GetDBContext()
            {
                ...
                {
                    Id = Guid.Parse("d8717962-8a03-4d7f-8442-794d8d11437f"),
                    FirstName = "captain", 
                    LastName = "M",
                    UserId = Guid.Parse("e4229706-9a92-4dfa-8bad-82c88aab6644")
                };
                ...
                {
                    Id = Guid.Parse("69f9f94e-4603-40f3-b858-9df2d2bf318a"),
                    EmailAddress = "captain@gmail.com",
                    EmailTypeId= Guid.Parse("4e11a79e-3d5b-4ef2-907e-0deafc19085d"),
                    AddressBookId = Guid.Parse("d8717962-8a03-4d7f-8442-794d8d11437f"),
                    UserId = Guid.Parse("e4229706-9a92-4dfa-8bad-82c88aab6644")
                };
                ...
                {
                    Id = Guid.Parse("082ac4c5-9c61-49ea-948c-75660b2f5a36"),
                    Line1 = "street",
                    Line2 = "50 feet road",
                    City = "cbe",
                    StateName = "TN",
                    ZipCode = "456789",
                    AddressTypeId = Guid.Parse("7c3b9028-3afc-4862-a058-91085f5c6217"),
                    CountryTypeId = Guid.Parse("edd5df89-09c2-44f8-8b7c-60e8a62c97e7"),
                    AddressBookId = Guid.Parse("d8717962-8a03-4d7f-8442-794d8d11437f"),
                    UserId = Guid.Parse("e4229706-9a92-4dfa-8bad-82c88aab6644")
                };
                ...
                {
                    Id = Guid.Parse("2a98e863-09c9-41c2-af44-26719380125c"),
                    PhoneNumber = "9877743200",
                    PhoneTypeId = Guid.Parse("af50fd89-c762-4429-ab7a-88f78f32a72c"),
                    AddressBookId = Guid.Parse("d8717962-8a03-4d7f-8442-794d8d11437f"),
                    UserId = Guid.Parse("e4229706-9a92-4dfa-8bad-82c88aab6644")
                };
